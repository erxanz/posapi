...
<body>
                            ...
                            <div style="padding: 1rem;">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding: 0.75rem; border: 1px solid #d1d5db;">remember_token
                                            </td>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0.75rem; border: 1px solid #d1d5db;">FK: categories
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0.75rem; border: 1px solid #d1d5db;">outlet_id</td>
    ...
    <div class="container">
            <div class="grid">
                <section class="card">
                    <h2>Diagram Relasi Database POS</h2>
                ...
                erDiagram
                    ...
                    OUTLETS ||--o{ CATEGORIES : "one-to-many"
                    CATEGORIES ||--o{ PRODUCTS : "one-to-many"
                    OUTLETS ||--o{ PRODUCTS : "one-to-many"
                    STATIONS ||--o{ PRODUCTS : "one-to-many"
                    OUTLETS ||--o{ STATIONS : "one-to-many"
                    OUTLETS ||--o{ TABLES : "one-to-many"
                    OUTLETS ||--o{ ORDERS : "one-to-many"
                    USERS ||--o{ ORDERS : "one-to-many"
                    TABLES ||--o{ ORDERS : "one-to-many"
                    ORDERS ||--o{ ORDER_ITEMS : "one-to-many"
                    PRODUCTS ||--o{ ORDER_ITEMS : "one-to-many"
                    STATIONS ||--o{ ORDER_ITEMS : "one-to-many"
